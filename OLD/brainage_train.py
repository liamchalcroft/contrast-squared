...
def run_model(args):
    ...
    train_dataset = IXIDataset(os.path.join(args.logdir, args.name, "ixi-features/guys/t1"), ixi_data, train_ids, train=False)
    val_dataset = IXIDataset(os.path.join(args.logdir, args.name, "ixi-features/guys/t1"), ixi_data, val_ids, train=False)
