...
if __name__ == "__main__":
    ...
    generate_qmri_slices(qmri_files, "data/qmri_slices", num_contrasts=100, slice_range=(50, 150))
    generate_mprage_slices(mprage_files, "data/mprage_slices", slice_range=(50, 150))
